...
parser.add_argument('--name_noise_ratio',  type=float, default=0.0)
parser.add_argument('--structure_noise_ratio',  type=float, default=0.0)
...
print('start exp: name_noise_ratio: {}, structure_noise_ratio: {}, if_structure: {}, lang: {}\n'.format(args.name_noise_ratio, args.structure_noise_ratio, args.if_structure, args.lang))
...
mask_id = random.sample(sample_list, int(64 * args.name_noise_ratio))
...
mask_id = random.sample(sample_list, int(352 * args.structure_noise_ratio))
...
sample_list = [i for i in range(64)]
mask_id = random.sample(sample_list, int(64 * args.structure_noise_ratio))
...
result_file = open(file_path + 'result_file_bi_ratio.txt', 'a', encoding='utf-8')
result_file.write("settings: name_noise_ratio: {}, structure_noise_ratio: {}, \n best results: hits@[1, 5, 10] = {}, mrr = {:.3f}\n".format(str(args.name_noise_ratio), str(args.structure_noise_ratio), best_acc, best_mrr))
