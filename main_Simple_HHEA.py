...
class Simple_HHEA(nn.Module):
    def __init__(self, ent_pair_size, time_span, ent_dw_emb, ent_name_emb, ent_time_emb, ent_rel_emb, emb_size=64, device='cuda'):
        ...
        self.fc_name_0 = nn.Linear(emb_size, emb_size)
        self.fc_time_0 = nn.Linear(32, 32)
        self.fc_dw_0 = nn.Linear(emb_size,emb_size)
    ...
    def forward(self):
        ...
        if args.if_structure:
            ...
            output_feature = torch.cat([ent_name_feature, ent_time_feature], 1)
...
result_file = open(file_path + 'result_file_mlp.txt', 'a', encoding='utf-8')
